...
public class AgeRange46to99 implements IEmergencyLoanAgeStrategy {
    ...
    public List<LoanType> processLoanOptions() {
        ...
        loanTypes.add(LoanOptionFactory.build(12, 2.5, 60000));
        loanTypes.add(LoanOptionFactory.build(18, 3.5, 80000));
        loanTypes.add(LoanOptionFactory.build(24, 4.0, 100000));
        return loanTypes;
    }
