...
@Component
public class Over36K implements IEmergencyLoanIncomeStrategy {

    private final EmergencyLoanAgeOptionsFactory emergencyLoanAgeOptionsFactory;

    public Over36K(EmergencyLoanAgeOptionsFactory emergencyLoanAgeOptionsFactory) {
    ...
    public CustomLoanResponse processLoanOptions(Integer age) {
        List<LoanType> loanTypes = emergencyLoanAgeOptionsFactory.getStrategy(age).processLoanOptions(2);
